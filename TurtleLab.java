...
public class TurtleLab
{
    ...
    {         
        ...
        Turtle crush3 = new Turtle(400,180,screen);// create a second Turtle object from the Turtle class, referenced by the variable 'crush'          
        Turtle crush4 = new Turtle(430,165,screen);// create a second Turtle object from the Turtle class, referenced by the variable 'crush'                 
        Turtle crush5 = new Turtle(430,225,screen);// create a second Turtle object from the Turtle class, referenced by the variable 'crush'                 
      
        crush1.setPenColor(Color.RED);//changes the object to red
        crush2.setPenColor(Color.BLUE);//changes the object to red
        crush3.setPenColor(Color.BLUE);//changes the object to red
        crush4.setPenColor(Color.BLACK);//changes the object to red      
        crush5.setPenColor(Color.BLACK);//changes the object to red  
